...
<jsp:include page="/Header.jsp">
	...
	<section>
		<div class="grid"><h1 class="big-text">Registrazione utente</h1></div>
		<div class="grid"><h5 class="med-text">Riempire tutti i campi</h5></div>
		
		<div class="grid">
		<form name="registrazione" action="Registrazione" method="post">
		
			<div class="leftal"><label>Nome </label>
			<input type="text" name="nome" oninput="validaNome()"></div>
			
			<div class="leftal"><label>Cognome</label>
			<input type="text" name="cognome" oninput="validaCognome()"></div>
			
			<div class="leftal"><label>Indirizzo</label>
			<input type="text" name="indirizzo" oninput="validaIndirizzo()"></div>
			
			<div class="leftal"><label>Telefono</label>
			<input type="text" name="telefono" oninput="validaTelefono()"></div>
			
			<div class="leftal"><label>Password <span style="font-size: 12px;"> (Inserire almeno 8 caratteri tra cui: una lettera maiuscola, una minuscola, un numero)</span></label>
			<input type="password" name="password" oninput="validaPassword()"></div>
			
			<div class="leftal"><label>Password (conferma)</label>
			<input type="password" name="passwordConferma" oninput="validaPassword()"></div>
			
			<div class="leftfull"><label>Email </label>
			<input type="text" name="email" oninput="validaEmail()"></div>
			
			<div class="leftfull"><label>Carta Di Credito</label>
			<input type="text" name="CartaCredito" oninput="validaCartaCredito()"></div>
